...
class PredictGreenEnergy:
    """
        This class shall  be used to perform:
                ...
                training of the XGBoost Regressor model,
    ...
    def train(self, preprocessed_df):
        """
                Method Name: train
                Description: This method creates an XGBoostRegression model
                Output: XGBoostRegression Model
        ...
        learning_rate, max_depth, n_estimators = self.obtain_best_params(x_train, y_train, x_test, y_test)
        ...
        try:
            ...
            xgb = XGBRegressor(learning_rate=learning_rate, max_depth=max_depth, n_estimators=n_estimators)
    ...
    def obtain_best_params(self, x_train, y_train, x_test, y_test):
        """
                ...
                Description: This method obtains the best hyperperameters for the xgboost model
        ...
        try:
            ...
            grid = GridSearchCV(XGBRegressor(), param_grid_xgboost, verbose=3, cv=5) #Using gridsearchcv for hyperparameter tuning
    ...
    def save_file(self, df):
        ...
        self.logger.log(file_object, log_message)
        try:
            df.to_csv('future_energy.csv', index=False) #conversion to csv format and saving
